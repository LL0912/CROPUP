...
from utils.helper_unite_mmd import *
...
with open("./config/model/unite_mmd.yaml") as f:
...
test_metric_all=train_model(seed,cfg_m,model,model_start_path,EPOCH,optimizer,lr_scheduler,criterion,device,
