...
#train the models
def train_model(seed, cfg_m,model,domain_adv, model_start_path, epochs, optimizer, lr_scheduler, criterion, device, train_loader_source,
    ...
    for i in tqdm(range(1, 1 + epochs)):
        ...
        for _ in progress_bar:
            ...
            total_loss = cls_loss + transfer_loss * cfg_m["transfer_loss"]["trade_off"]
            ...
            domain_accs.update(domain_acc, batch_size)
